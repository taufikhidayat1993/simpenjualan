            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    ...
                    <a class="dropdown-toggle"  href="destroy_pasien.php">
                      <i class="fa fa fa-sign-out fa-fw"></i><i class="fa fa-table fa-fw"></i>Daftar Pasien Rawat Inap
                    </a>
                    <li class="dropdown">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <li>
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-stethoscope fa-fw"></i> Diagnosa</a>
                        </li>
                                              <li>
                            <a href="tables.html"><i class="glyphicon glyphicon-edit  glyphicon-fw"></i> Tindakan</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa  fa-flask fa-fw"></i> Labolatorium</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="glyphicon glyphicon-file glyphicon-fw"></i> Radiologi</a>
                        </li>
