...
$row_count = sqlsrv_num_rows( $stmt );
  ...
  <div class="pane-hScroll1">
				...
				<th style="width:230px;" >Diagnosa</th></tr></thead></table> <div class="pane-vScroll"> <table width="100%" id="table"><tbody>';
					if ($row_count > 0){
						...
						<td style="width:70px;">'.$data['PENYAKIT_ID'].'</td><td class=tanggal style="width:250px;">'.$data['NAME'].'</td></tr>';
	         		}
				echo '
